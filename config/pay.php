...
// 文档地址 https://pay.yansongda.cn/docs/v3/quick-start/init.html
...
$config = [
    ...
    'wechat' => [
        'default' => [
            ...
            'mch_secret_cert' => storage_path('app/cert/wechat_pay/apiclient_key.pem'),
            // 「必填」商户公钥证书路径
            // 即 API证书 CERTIFICATE，可在 账户中心->API安全->申请API证书 里获得
            // 文件名形如：apiclient_cert.pem
            'mch_public_cert_path' => storage_path('app/cert/wechat_pay/apiclient_cert.pem'),
            // 「必填」微信回调url
            // 不能有参数，如?号，空格等，否则会无法正确回调
            'notify_url' =>  asset(env("PAY_WECHAT_NOTIFY_URL", '')),
            // 「选填」公众号 的 app_id
            ...
            // 「必填」微信支付公钥ID及证书路径，key 填写形如 PUB_KEY_ID_0117398248442026031000191998000201 的公钥id，见 https://pay.weixin.qq.com/doc/v3/merchant/4013053249
            'wechat_public_cert_path' => [
                'PUB_KEY_ID_0117398248442026031000191998000201' => storage_path('app/cert/wechat_pay/pub_key.pem'),
            ],
    ...
    'logger' => [
        'enable' => false,
        'file' => './logs/yansongda-pay/pay.log',
        'level' => 'info', // 建议生产环境等级调整为 info，开发环境为 debug
        'type' => 'daily', // optional, 可选 daily.
        'max_file' => 360, // optional, 当 type 为 daily 时有效，默认 30 天
    ],
    'http' => [ // optional
        'timeout' => 5.0,
        'connect_timeout' => 5.0,
